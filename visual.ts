...
export class GdmLiveAudioVisuals extends LitElement {
  ...
  // FIX: Use @query decorator to get a reference to the canvas element.
  ...
  // FIX: Lit lifecycle methods should be protected, not private.
  protected firstUpdated() {
    // FIX: The `canvas` property is now populated by the `@query` decorator, so manual assignment is no longer needed.
